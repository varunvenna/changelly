...
class ExchangeWidget extends Component {
	...
	componentWillReceiveProps(nextProps) {
		if ($('#exchange-widget [data-toggle="tooltip"]').attr("aria-describedby")) {
			...
			$(`#${tooltipId} .tooltip-inner`).html(`The fee amounts to ${(nextProps.amounts.deposit * 0.01)} ${nextProps.selectedCoin.deposit}.`);
		}
					...
					<div className="col-xs-12 text-center">
						...
						<p id="fee-info">
							<i className="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title=""
								data-original-title={`The fee amounts to ${(this.props.amounts.deposit * 0.01)} ${this.props.selectedCoin.deposit}.`}>
							</i>
						</p>
					</div>
				</div>
