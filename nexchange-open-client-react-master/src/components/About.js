    ...
    <div className="container">
      <div className="row">
        <div className="col-xs-12">
          ...
          <p>Cripx is a fast, reliable and fully transparent cryptocurrency exchange built by crypto enthusiasts, for crypto enthusiasts.</p>
          ...
          <p>Cripx is built on several core values that guide our team in our day to day operations.</p>
